...
while True:
    if pyautogui.locateOnScreen('retry.png', region=(773,581,379,304), grayscale=True, confidence=0.6) != None:
         pyautogui.click(952, 717)
         time.sleep(0.5)
         pyautogui.click(952, 717)
     
    if pyautogui.locateOnScreen('ManuNotReady.png', region=(0,538,447,528), grayscale=True, confidence=0.6) != None:
        pyautogui.click(230, 950)
        time.sleep(0.5)
     
    if pyautogui.locateOnScreen('ManuNotReady2.png', region=(0,538,447,528), grayscale=True, confidence=0.6) != None:
        pyautogui.click(230, 950)
        time.sleep(0.5)
    ...
    if pyautogui.locateOnScreen('InGame.png', region=(87,755,379,304), grayscale=True, confidence=0.3) != None:
